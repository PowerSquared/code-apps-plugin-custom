---
name: add-mcscopilot
description: Add Microsoft Copilot Studio connector to a Power Apps code app. Use when the user wants to invoke a Copilot Studio agent from their app.
compatibility: Requires pac CLI, a Microsoft Copilot Studio Power Platform connection, and a published Copilot Studio agent.
---
...
Use `Grep` to find specific methods in the generated service file (generated files can be very large — see `.agent-docs/connector-reference.md`).
