---
name: add-dataverse
description: Add Dataverse tables to a Power Apps code app with generated TypeScript models and services. Use when the user wants to store or manage custom business data.
compatibility: Requires pac CLI, a Power Platform environment, and optionally Azure CLI for creating new tables.
---
