---
name: add-datasource
description: Router skill that understands the user's goal and routes to the right data source skill. Use when the user wants to connect their app to data but isn't sure which connector to use.
---
