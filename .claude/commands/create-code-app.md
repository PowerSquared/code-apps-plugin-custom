...
- [prerequisites-reference.md](.agent-docs/skills/create-code-app/references/prerequisites-reference.md) - Prerequisites and required permissions
- [troubleshooting.md](.agent-docs/skills/create-code-app/references/troubleshooting.md) - Common issues, npm scripts, resources
...
Check for `memory-bank.md` per [shared-instructions.md](.agent-docs/shared-instructions.md). Skip completed steps.

### Step 1: Validate Prerequisites

Run prerequisite checks **first** -- no point gathering requirements if the environment isn't ready. See [prerequisites-reference.md](.agent-docs/skills/create-code-app/references/prerequisites-reference.md) for details.
...
3. Present plan for approval, include `allowedPrompts` from [prerequisites-reference.md](.agent-docs/skills/create-code-app/references/prerequisites-reference.md)
...
See [preferred-environment.md](.agent-docs/preferred-environment.md) for details.
...
**Common deploy errors:** See [troubleshooting.md](.agent-docs/skills/create-code-app/references/troubleshooting.md).
...
1. **Review generated services**: Use `Grep` to find methods in generated service files (they can be very large -- see [connector-reference.md](.agent-docs/connector-reference.md#inspecting-large-generated-files)). Do NOT read entire generated files.
...
- Read [dataverse-reference.md](.agent-docs/skills/add-dataverse/references/dataverse-reference.md) if working with Dataverse (picklist fields, virtual fields, lookups have critical gotchas)
