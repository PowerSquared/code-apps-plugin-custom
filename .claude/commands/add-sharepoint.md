...
Check for `memory-bank.md` per [shared-instructions.md](.agent-docs/shared-instructions.md).
...
Find the SharePoint Online connection ID (see [connector-reference.md](.agent-docs/connector-reference.md)):
...
Use `Grep` to find specific methods in `src/generated/services/SharePointOnlineService.ts` (generated files can be very large -- see [connector-reference.md](.agent-docs/connector-reference.md#inspecting-large-generated-files)).
