...
Use `Grep` to find specific methods in `src/generated/services/TeamsService.ts` (generated files can be very large -- see [connector-reference.md](.agent-docs/connector-reference.md#inspecting-large-generated-files)).
