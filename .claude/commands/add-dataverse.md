**📋 Shared Instructions: [shared-instructions.md](.agent-docs/shared-instructions.md)** - Cross-cutting concerns.

**References:**

- [dataverse-reference.md](.agent-docs/skills/add-dataverse/references/dataverse-reference.md) - Picklist fields, virtual fields, lookups, file/image columns, form patterns (CRITICAL)
- [api-authentication-reference.md](.agent-docs/skills/add-dataverse/references/api-authentication-reference.md) - Dataverse API auth, token, publisher prefix
- [table-management-reference.md](.agent-docs/skills/add-dataverse/references/table-management-reference.md) - Query, create, extend tables and columns
- [data-architecture-reference.md](.agent-docs/skills/add-dataverse/references/data-architecture-reference.md) - Relationship types, dependency tiers
...
- Build a dependency graph -- see [data-architecture-reference.md](.agent-docs/skills/add-dataverse/references/data-architecture-reference.md) for tier classification
...
See [api-authentication-reference.md](.agent-docs/skills/add-dataverse/references/api-authentication-reference.md) for full details.
...
See [table-management-reference.md](.agent-docs/skills/add-dataverse/references/table-management-reference.md) for `Find-SimilarTables`, `Compare-TableSchemas`, and `Build-TableNameMapping` functions.
...
Use safe functions from [table-management-reference.md](.agent-docs/skills/add-dataverse/references/table-management-reference.md):

- `New-DataverseTableIfNotExists`
- `Add-DataverseColumnIfNotExists`
- `Add-DataverseLookupIfNotExists` (from [data-architecture-reference.md](.agent-docs/skills/add-dataverse/references/data-architecture-reference.md))
...
- **Read [dataverse-reference.md](.agent-docs/skills/add-dataverse/references/dataverse-reference.md) before writing any Dataverse code** -- picklist fields, virtual fields, lookups, and file/image columns all have critical gotchas
